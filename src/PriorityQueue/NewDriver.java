...
public class NewDriver {
    public static void main(String [] args) {
        PriorityQueue<Integer> pq = new UnorderedLinkedListPriorityQueue<Integer>();
        System.out.println("Grading the UnorderedLinkedList implementation");        
        try {
            for(int i=10; i > 0; i--)
                if(!pq.insert(i))
        ...
        int [] LinkedList = new int[100];
        for(int i=0; i < 100; i++)
            LinkedList[i] = i;
        for(int i=0; i < 100; i++) {
            int newIndex = (int) (100*Math.random());
            int tmp = LinkedList[i];
            LinkedList[i] = LinkedList[newIndex];
            LinkedList[newIndex] = tmp;
            }
        ...
        try {
            PriorityQueue<Item> pq2 = new UnorderedLinkedListPriorityQueue<Item>();
